...
A simple native WYSIWYG/Rich Text editor for Angular 6-12+. The Changes from the initial repository were made to include youtube videos as an embed instead of a link. Videos are now inserted as a full width embed.
